...
Start the reply with **5–8 plain-language lines**: what breaks, where we change it, what the user will verify. Only then write the artifacts. The user must never need a «объясни проще» follow-up.
