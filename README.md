...
Профиль [Pi](https://github.com/badlogic/pi-mono) для разработки на **1С:Предприятие**.
...
|---|---|---|
| **Cognee** (`memory`, порт 8001) | Короткие факты, решения, предпочтения, уроки из ошибок | «в проекте X расширение МОЁ_ — целевой контейнер», «на этой базе остатки — РегистрНакопления.ТоварыНаСкладах» |
...
└── .pi/
    └── 1c/
        ...
        └── rules/
            ...
            └── project/            # правила проекта: «все новые объекты — в расширение МОЁ_»
```
...
```
/rule add project :: extensions :: все новые объекты создаём в расширении МОЁ_
```
