...
| **Ordinary form (обычная форма)** — `Ext/Form.bin` and no `Form.xml` | `C:/DevopsMoments/pi-agents/config-1c/skills/v8unpack-cf/SKILL.md → Ordinary forms` — nothing on this page applies |
